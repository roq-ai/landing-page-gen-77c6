  ...
  const fetcher = useCallback(
    async () =>
      getClients({
        relations: [
          'user',
          'content_creator.count',
          'landing_page.count',
          'marketing_manager.count',
          'team_member.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('landing_page', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.landing_page,
        }
      : null,
    hasAccess('marketing_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'marketing_manager',
          header: 'Marketing Manager',
          accessorKey: 'marketing_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.marketing_manager,
        }
      : null,
