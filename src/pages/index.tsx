  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the Power of Instant Creativity with Landing Page Generator - Your Ultimate Solution for Customizable Landing Pages on Demand."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1453928582365-b6ad33cbcf64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsYW5kaW5nJTIwcGFnZXxlbnwwfHx8fDE2OTQ1MDAxNDh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@laurenmancke?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Lauren Mancke`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Power of Instant Creativity with Landing Page Generator - Your Ultimate Solution for Customizable Landing Pages on Demand.`}
            </Text>
            <Box
