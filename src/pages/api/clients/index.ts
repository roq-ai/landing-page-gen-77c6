...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createClient() {
    ...
    if (body?.marketing_manager?.length > 0) {
      const create_marketing_manager = body.marketing_manager;
      body.marketing_manager = {
        create: create_marketing_manager,
      };
    } else {
      delete body.marketing_manager;
    }
