...
import { getMarketingManagerById } from 'apiSdk/marketing-managers';
import { MarketingManagerInterface } from 'interfaces/marketing-manager';

function MarketingManagerViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Marketing Manager Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('marketing_manager', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/marketing-managers/edit/${id}`} passHref legacyBehavior>
                    <Button
