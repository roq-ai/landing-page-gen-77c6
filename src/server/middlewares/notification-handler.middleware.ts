...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'landing_page.create': {
    roles: ['business-owner', 'team-member', 'content-creator', 'marketing-manager'],
    key: 'landing-page-created',
    tenantPath: ['client', 'landing_page'],
    userPath: [],
  },
  'landing_page.update': {
    roles: ['business-owner', 'team-member', 'content-creator', 'marketing-manager'],
    key: 'landing-page-updated',
    tenantPath: ['client', 'landing_page'],
    userPath: [],
  },
  'landing_page.delete': {
    roles: ['business-owner', 'team-member', 'content-creator', 'marketing-manager'],
    key: 'landing-page-deleted',
    tenantPath: ['client', 'landing_page'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'content-creator', 'marketing-manager'];
